        ...
        <div className="flex flex-col items-center justify-center min-h-screen-layout">
            ...
            {user ? ( // If the user is logged in, show different content
                <div className="flex flex-col items-center">
                    ...
                    <Link href="/profile" className="bg-black text-white px-6 py-2 rounded-full shadow-md hover:bg-opacity-95 transition duration-200">
                        Go to Profile
                    </Link>
                </div>
            ) : ( // If the user is not logged in, show the Register and Login buttons
                <div className="flex gap-4">
                    <Link href="/register" className="bg-black text-white px-6 py-2 rounded-full shadow-md hover:bg-opacity-95 transition duration-200">
                        Register
                    </Link>
                    <Link href="/login" className="text-black  px-6 py-2 rounded-full shadow-md border-2 hover:bg-gray-200 transition duration-200">
                        Login
                    </Link>
                </div>
            )}
