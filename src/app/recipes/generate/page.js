...
import AuthentComponent from "@/components/authentComponent";
...
const CreateRecipe = () => {
    ...
    const { user } = useAuth();
    const { isClear } = useContext(RecipeContext);
    ...
    return (
        <div className="flex flex-col items-center md:overflow-y-hidden justify-end min-h-screen">
            ...
            {user ? <main className="h-dvh flex-1 md:p-6 md:overflow-y-hidden flex flex-col items-center justify-between">
                {recipe ? (
                        ...
                        <div className="mt-6 max-w-3xl w-full grid grid-cols-2 gap-4">
                            ...
                            <button
                                ...
                                className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 hover:shadow-md transition">
                                <p className="text-sm font-medium text-gray-800">J&rsquo;ai des boutons
                                    d&rsquo;acné</p>
                            </button>
                        </div>
                    </div>
                ...
                <div className="w-full max-w-3xl rounded-lg sticky mb-8 border-gray-50">
                    <form onSubmit={handleGenerateRecipe}
                          className="flex items-center bg-gray-200 rounded-full shadow-md">
                        <input
                            type="text"
